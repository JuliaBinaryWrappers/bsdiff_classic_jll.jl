...
if VERSION < v"1.3.0-rc4"
    ...
    error("Unable to import bsdiff_classic_jll on Julia versions older than 1.3!")
end
...
artifacts = Pkg.Artifacts.load_artifacts_toml(artifacts_toml; pkg_uuid=UUID("7424abe3-9926-5da8-9b28-863d6330819c"))
platforms = [Pkg.Artifacts.unpack_platform(e, "bsdiff_classic", artifacts_toml) for e in artifacts["bsdiff_classic"]]
...
if best_platform === nothing
    @debug("Unable to load bsdiff_classic; unsupported platform $(triplet(platform_key_abi()))")
else
